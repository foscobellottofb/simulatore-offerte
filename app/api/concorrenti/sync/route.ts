...
Dolomiti Energia. Obiettivo: fino a 20 offerte totali, includendo più fornitori possibile invece di
concentrarti solo sui primi 2-3 che trovi. Se il Portale Offerte non è accessibile, cerca invece
...
- Fino a 20 offerte, provenienti da più fornitori diversi quando possibile, solo quelle con un prezzo
  esplicito e verificabile. Se per un fornitore non trovi nulla di affidabile, saltalo e passa al
  successivo piuttosto che fermarti.`;
    ...
    messages: [
      {
        role: 'user',
        content:
          'Cerca le offerte business luce e gas attualmente pubblicate dai principali fornitori italiani, facendo una ricerca per ciascun fornitore elencato nelle istruzioni, non fermarti ai primi risultati.'
      }
    ],
