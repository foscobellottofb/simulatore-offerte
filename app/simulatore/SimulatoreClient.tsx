                        ...
                        <div>
                          ...
                          <div className="text-xs text-enel-ink/50 flex items-center justify-end gap-1 flex-wrap">
                            ...
                            <input
                              ...
                              className="w-11 text-center border border-sky-300 bg-sky-100 rounded px-1 py-0.5 text-xs font-medium focus:outline-none focus:ring-1 focus:ring-sky-400"
