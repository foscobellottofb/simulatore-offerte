...
// useSearchParams() obbliga Next.js a wrappare il componente che lo usa in
// un <Suspense>, altrimenti il build fallisce in fase di export statico
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-enel-paper px-4">
      <Suspense fallback={<div className="text-sm text-enel-ink/40">Caricamento…</div>}>
        <LoginForm />
      </Suspense>
    </div>
  );
